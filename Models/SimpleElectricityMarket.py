...
#       Demands:
n.add(
    "Load", "SA electricity demand", bus="SA", carrier="electricity", p_set=loads["SA"]
)
n.add(
    "Load", "MZ electricity demand", bus="MZ", carrier="electricity", p_set=loads["MZ"]
)
print(n.loads)
...
#       Global Constraint for Emission Limit:
generators_emissions = (
    n.generators_t.p
    / n.generators.efficiency
    * n.generators.carrier.map(n.carriers.co2_emissions)
)
total_emissions = generators_emissions.sum().sum()
